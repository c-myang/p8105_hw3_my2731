...
Based on the table, Coffee Ice Cream is usually ordered in the early afternoon for every day of the week while Pink Lady Apples range from being ordered, on average, after 11am and after 2pm.
...
For snowfall, the most commonly observed values are `0`, `NA`, and `25`, respectively. Intuitively, this is reasonable because snow does not fall year-round and therefore, most days of the year would observe 0 snowfall.

### Plotting average max temperature

Make a two-panel plot showing the average max temperature in January and in July in each station across years. Is there any observable / interpretable structure? Any outliers?

The resulting plots show the average maximum daily temperature in January and July from 1981-2010. The average max temperature in Jaunary tends to fluctuate around zero degrees Celsius, while the temperature for July varies around 27 degrees Celsius. We can see slight similarities in the variation In addition, the average maximum temperature for January appears to have more variation compared to that of July.
...
janjul_p = noaa_clean %>% 
  ...
  labs(
    ...
    title = "Average daily maximum temperature, 1981 to 2010",
